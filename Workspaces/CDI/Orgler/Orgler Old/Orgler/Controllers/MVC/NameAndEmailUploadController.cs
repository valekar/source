...
namespace Orgler.Controllers.MVC
{
    public class NameAndEmailNativeController : BaseController
    {
        ...
        public async Task<JsonResult> postNameAndEmailUploadData(string uploadedNameAndEmailFormData)
        {
            ...
            List<NameAndEmailUploadJsonFileDetailsHelper> _uploadJsonDetails = (List<NameAndEmailUploadJsonFileDetailsHelper>)TempData["UploadJsonDetails"];
            ...
            gm.ListNameAndEmailUploadJsonFileDetailsInput = _uploadJsonDetails;
        ...
        public async Task<JsonResult> ValidateNameAndEmailUploadFiles()
        {
            ...
            for (int iCnt = 0; iCnt <= hfc.Count - 1; iCnt++)
            {
                ...
                {
                    NameAndEmailUploadJsonFileDetailsHelper jsonhelper = new NameAndEmailUploadJsonFileDetailsHelper();
                    ...
                    List<NameAndEmailUploadJsonFileDetailsHelper> UploadStatusFileDetails = new List<NameAndEmailUploadJsonFileDetailsHelper>();

                    var jsonresult = serializer.Deserialize<List<NameAndEmailUploadJsonFileDetailsHelper>>(JSONString);
                                ...
                                try
                                {
                                    ...
                                    if (check)
                                    {
                                        ...
                                        for (int rw = 3; rw <= ws.Dimension.End.Row; rw++)
                                        {
                                            ...
                                            {
                                                lgl.NameAndEmailUploadInputList.Add(new NameAndEmailUploadInput()
                                                {
