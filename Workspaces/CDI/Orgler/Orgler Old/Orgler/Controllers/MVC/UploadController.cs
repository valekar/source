    ...
    public class UploadNativeController : BaseController
    {
        ...
        public async Task<JsonResult> ValidateFiles()
        {
            ...
            if (iUploadedCnt > 0)
            {
                ...
                //savedFilePath = "D:/Projects/Stuart V2/Stuart UI/Orgler/Files/" + fileName;
        ...
        public async Task<FileContentResult> getTransExportAllUpload(string id)
        {
            ...
            checkExceptions(res);
            List<Orgler.Models.Entities.Transaction.TransactionUploadDetails> result = (new JavaScriptSerializer()).Deserialize<List<Orgler.Models.Entities.Transaction.TransactionUploadDetails>>(res);
