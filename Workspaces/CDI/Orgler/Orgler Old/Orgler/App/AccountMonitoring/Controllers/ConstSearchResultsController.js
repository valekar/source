angular.module('constituent').controller('constituentSearchResultsController', ['$scope', 'constituentServices', 'constituentDataServices', 'mainService', 'constMultiGridService',
    'uiGridConstants', '$window', '$http', '$localStorage', '$sessionStorage', 'constClearDataService', '$location', '$rootScope', 'exportService', 'globalServices', '$timeout',
    function ($scope, constituentServices, constituentDataServices, mainService, constMultiGridService, uiGridConstants, $window, $http, $localStorage, $sessionStorage,
        ...
        //function selectedSpecificGrid($scope) {
        //    //This will show all records by default.
        //    $scope.searchResultsGridOptions.enableFiltering = !$scope.searchResultsGridOptions.enableFiltering;
        //    $scope.ShowNaicscodeData = function (value) {
        //        if (value == true)                  
        //        var pos = $scope.searchResultsGridOptions.columnDefs.map(function (e) { return e.field; }).indexOf('yourFieldName');
        //        var pos = $scope.searchResultsGridOptions.columnDefs.map(function (e) { return e.field; }).indexOf('yourFieldName');
        //        var pos = $scope.searchResultsGridOptions.columnDefs.map(function (e) { return e.field; }).indexOf('yourFieldName');
        //        var pos = $scope.searchResultsGridOptions.columnDefs.map(function (e) { return e.field; }).indexOf('yourFieldName');
        //    else
