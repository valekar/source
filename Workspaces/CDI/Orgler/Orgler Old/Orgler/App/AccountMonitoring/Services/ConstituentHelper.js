...
GridColumns.prototype.getGridColumns = function (uiGridConstants, $rootScope) {
    ...
    return {
        ...
        constOrgNameColDef: [
            ...
            {
                field: 'Action', cellTemplate: 'App/Constituent/Views/common/gridDropDown.tpl.html', displayName: 'User Actions', headerCellTemplate: '<div>User Actions</div>',
                width: "*", minWidth: 320, maxWidth: 9000//, headerCellTemplate: GRID_FILTER_TEMPLATE
            }
        ...
        constAddressColDef: [
                ...
                {
                    field: 'cnst_addr_line2_addr', headerCellTemplate: GRID_HEADER_TEMPLATE, menuItems: customGridFilter(HOME_CONSTANTS.CONST_ADDRESS, $rootScope),
                    displayName: 'Address Line 2', width: "*", minWidth: 150, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
                ...
                },
                {
                 ...
                 {
                     field: 'best_addr_ind', headerCellTemplate: GRID_HEADER_TEMPLATE, menuItems: customGridFilter(HOME_CONSTANTS.CONST_NAME, $rootScope),
                 ...
                 {
                     field: 'addr_typ_cd', headerCellTemplate: GRID_HEADER_TEMPLATE, menuItems: customGridFilter(HOME_CONSTANTS.CONST_NAME, $rootScope),
                 ...
                 },
                 {
                  ...
                  {
                      field: 'res_deliv_ind', headerCellTemplate: GRID_HEADER_TEMPLATE, menuItems: customGridFilter(HOME_CONSTANTS.CONST_NAME, $rootScope),
                  ...
                  {
                      field: 'dpv_cd', headerCellTemplate: GRID_HEADER_TEMPLATE, menuItems: customGridFilter(HOME_CONSTANTS.CONST_NAME, $rootScope),
                      displayName: 'DPV Code', visible: true, width: "*", minWidth: 90, maxWidth: 9000,
                      filter: {
                          condition: uiGridConstants.filter.STARTS_WITH
                      },
                      cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
                  ...
                  {
                      field: 'cnst_addr_strt_ts', headerCellTemplate: GRID_HEADER_TEMPLATE, menuItems: customGridFilter(HOME_CONSTANTS.CONST_NAME, $rootScope),
                  ...
                  {
                      field: 'cnst_addr_end_dt', headerCellTemplate: GRID_HEADER_TEMPLATE, menuItems: customGridFilter(HOME_CONSTANTS.CONST_NAME, $rootScope),
                      displayName: 'End Date', visible: false, width: "*", minWidth: 130, maxWidth: 9000,
                      filter: {
                          condition: uiGridConstants.filter.STARTS_WITH
                      },
        ...
        constPhoneColDef: [
              //  { field: 'cnst_mstr_id', displayName: 'Master Id', enableCellEdit: false },
                ...
                },
                {
                 ...
                 {
                     field: 'best_phn_ind', headerCellTemplate: GRID_HEADER_TEMPLATE, menuItems: customGridFilter(HOME_CONSTANTS.CONST_NAME, $rootScope),
                     displayName: 'ARC Best', sort: { direction: uiGridConstants.DESC, priority: 1 }, width: "*", minWidth: 60, maxWidth: 9000,
                     filter: {
                         condition: uiGridConstants.filter.STARTS_WITH
                     },
                 ...
                 },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source System Code', minWidth: 120, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
        ...
        constEmailColDef: [
               // { field: 'cnst_mstr_id', displayName: 'Master Id', enableCellEdit: false },
                ...
                },
                {
                 ...
                 {
                     field: 'best_email_ind', headerCellTemplate: GRID_HEADER_TEMPLATE, menuItems: customGridFilter(HOME_CONSTANTS.CONST_NAME, $rootScope),
                     displayName: 'ARC Best', sort: { direction: uiGridConstants.DESC, priority: 1 }, width: "*", minWidth: 60, maxWidth: 9000,
                     filter: {
                         condition: uiGridConstants.filter.STARTS_WITH
                     },
                 ...
                 },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys Code', minWidth: 100, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys ID', minWidth: 100, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Email Type', width: "*", minWidth: 80, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
...

                {
                ...
                },
                 {
                     ...
                     displayName: "Assessment Code", headerCellTemplate: GRID_HEADER_TEMPLATE, visible: true,
                     filter: {
                         condition: uiGridConstants.filter.STARTS_WITH
                     },
        ...
        constBirthColDef: [
               // { field: 'cnst_mstr_id', displayName: 'Master Id', enableCellEdit: false },
                ...
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys Code', width: "*", minWidth: 120, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys ID', width: "*", minWidth: 120, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
        ...
        constDeathColDef: [
               // { field: 'cnst_mstr_id', displayName: 'Master Id', enableCellEdit: false },
                ...
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys Code', width: "*", minWidth: 140, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys ID', width: "*", minWidth: 140, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
        ...
        constPrefColDef: [
               // { field: 'cnst_mstr_id', displayName: 'Master Id', enableCellEdit: false },
                ...
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys Code', width: "*", minWidth: 100, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys ID', width: "*", minWidth: 100, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
        ...
        grpMembershipColDef: [
              //  { field: 'cnst_mstr_id', displayName: 'Master Id', enableCellEdit: false },
                ...
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys Code', width: "*", minWidth: 120, maxWidth: 9000, visible: true,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
        ...
        transHistoryColDef: [
             {
                ...
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Sub Transaction Action Type',visible:false,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>',
                ...
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys Code', visible: true,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>',
                ...
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Source Sys ID', visible: true,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>',
        ...
        anonInfoColDef: [
            ...
            },
            {
                ...
                headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Arc Source System', width: "*", minWidth: 120, maxWidth: 9000,
                filter: {
                    condition: uiGridConstants.filter.STARTS_WITH
                },
                cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
        ...
        intBridgeColDef: [
              //  { field: 'cnst_mstr_id', displayName: 'Master Id', enableCellEdit: false },
                ...
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Subject Area Key', width: "*", minWidth: 100, maxWidth: 9000,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
                ...
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Application Source Code', width: "*", minWidth: 140, maxWidth: 9000, visible: false,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
        ...
        showBirthColdef: [
             {
             ...
             },
              {
                  ...
                  displayName: "Source Sys Code", headerCellTemplate: GRID_HEADER_TEMPLATE,
                  filter: {
                      condition: uiGridConstants.filter.STARTS_WITH
                  },
                  //cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
            ...
            {
                field: 'cnst_srcsys_id', width: "*", minWidth: 100, maxWidth: 9000,
                displayName: "Source Sys Id", headerCellTemplate: GRID_HEADER_TEMPLATE,
                filter: {
                    condition: uiGridConstants.filter.STARTS_WITH
                },
                // cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
        ...
        showDeathColdef: [
            ...
            },
            {
                ...
                displayName: "Source System Code", headerCellTemplate: GRID_HEADER_TEMPLATE,
                filter: {
                    condition: uiGridConstants.filter.STARTS_WITH
                },
        ...
        showNameColdef: [
                ...
                },
                {
                    ...
                    displayName: "Arc Source System", headerCellTemplate: GRID_HEADER_TEMPLATE,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                ...
                {
                    field: 'cnst_srcsys_id', width: "*", minWidth: 150, maxWidth: 9000,
                    displayName: "Source Id", headerCellTemplate: GRID_HEADER_TEMPLATE,
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
        ...
        showCharacteristicsColdef: [
             ...
             {
                 field: 'arc_srcsys_cd', width: "*", minWidth: 140, maxWidth: 9000,
                 displayName: "Arc Source Code", headerCellTemplate: GRID_HEADER_TEMPLATE,
                 filter: {
                     condition: uiGridConstants.filter.STARTS_WITH
                 },
