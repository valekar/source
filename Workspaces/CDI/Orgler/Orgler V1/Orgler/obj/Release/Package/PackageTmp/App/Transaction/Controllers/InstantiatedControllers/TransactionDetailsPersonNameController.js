angular.module('transaction').controller('TransactionDetailsPersonNameController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_PERSON_NAME);
    ...
    //console.log("In Person Name Details Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiPersonNameDetails(params).success(function (results) {
