...
enterpriseAccMod.controller("enterpriseOrgDetailsCtrl",
    ['$scope', '$rootScope', '$stateParams', 'enterpriseDetailsService', 'exportService', 'uiGridConstants',
        'EnterpriseAccountDataService', '$filter', 'EnterpriseAccountService', 'ENT_DETAIL_CRUD', 'EXTENDED_FUNC', 'ExtendedStoreData', 'ExtendedServices',
    function ($scope, $rootScope, $stateParams, enterpriseDetailsService, exportService, uiGridConstants,
        EnterpriseAccountDataService, $filter, service, ENT_DETAIL_CRUD, EXTENDED_FUNC, StoreData, ExtendedServices) {
        ...
        $scope.entOrgHierarchyGridOptions.rowTemplate = '';
        ...
        $scope.entOrgHierarchyGridOptions.rowHeight = 85;
            ...
            if (sectionName == "EntOrgHierarchy") {
                ...
                if (!dataFlag) {
                    ...
                    .success(function (result) {
                        ...
                        {
                            if (!angular.isUndefined($scope.entOrgHierarchyGridOptions.data[0].lvl5_ent_org_id) && $scope.entOrgHierarchyGridOptions.data[0].lvl5_ent_org_id != null && $scope.entOrgHierarchyGridOptions.data[0].lvl5_ent_org_id != '') {
                                level = 5;
                            ...
                            else if (!angular.isUndefined($scope.entOrgHierarchyGridOptions.data[0].lvl4_ent_org_id) && $scope.entOrgHierarchyGridOptions.data[0].lvl4_ent_org_id != null && $scope.entOrgHierarchyGridOptions.data[0].lvl4_ent_org_id != '') {
                                level = 4;
                            ...
                            else if (!angular.isUndefined($scope.entOrgHierarchyGridOptions.data[0].lvl3_ent_org_id) && $scope.entOrgHierarchyGridOptions.data[0].lvl3_ent_org_id != null && $scope.entOrgHierarchyGridOptions.data[0].lvl3_ent_org_id != '') {
                                level = 3;
                            ...
                            else if (!angular.isUndefined($scope.entOrgHierarchyGridOptions.data[0].lvl2_ent_org_id) && $scope.entOrgHierarchyGridOptions.data[0].lvl2_ent_org_id != null && $scope.entOrgHierarchyGridOptions.data[0].lvl2_ent_org_id != '') {
                                level = 2;
                            ...
                            else if (!angular.isUndefined($scope.entOrgHierarchyGridOptions.data[0].lvl1_ent_org_id) && $scope.entOrgHierarchyGridOptions.data[0].lvl1_ent_org_id != null && $scope.entOrgHierarchyGridOptions.data[0].lvl1_ent_org_id != '') {
                                level = 1;
