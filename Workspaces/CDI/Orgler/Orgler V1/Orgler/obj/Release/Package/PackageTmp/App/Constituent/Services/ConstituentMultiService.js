angular.module('constituent').constant('CONSTANTS', {
    BEST_SMRY: 'BestSmry',
...
angular.module('constituent').factory('constMultiDataService', ['CONSTANTS', function (CONSTANTS) {
    // var bestSmryData = [];
    ...
    return {
        ...
        getData: function (type) {
            switch (type) {
                ...
                case CONSTANTS.RFMVALUES_DETAILS: { return allConstDatas.rfmValuesDetails; break; };
            }
        },
        ...
        setData: function (resultData, type) {
            switch (type) {
                ...
                case CONSTANTS.RFMVALUES_DETAILS: { allConstDatas.rfmValuesDetails = resultData; break; };
        ...
        setFullData: function (resultData, type) {
            switch (type) {
                ...
                case CONSTANTS.RFMVALUES_DETAILS: { allConstFullDatas.rfmValuesDetails = resultData; break; };
        ...
        getFullData: function (type) {
            switch (type) {
                ...
                case CONSTANTS.RFMVALUES_DETAILS: { return allConstFullDatas.rfmValuesDetails; break; };
            }
        },
...
var allGrids = {
    ...
    rfmValuesDetailsGrid: null
}

angular.module('constituent').factory('constMultiGridService', ['uiGridConstants', 'CONSTANTS', '$rootScope', '$window', function (uiGridConstants, CONSTANTS, $rootScope, $window) {
    ...
    return {
        ...
        getGridOptions: function (uiGridConstants, type,pages) {
            ...
            switch (type) {
                ...
                case CONSTANTS.RFMVALUES_DETAILS: {
                    allGrids.rfmValuesDetailsGrid = typeof null ? new Grid(columnDefs.showRFMValuesDetailsColdef) : allGrids.rfmValuesDetailsGrid;
                    gridOptions.rfmValuesDetailsGridOption = allGrids.rfmValuesDetailsGrid.getGridOption(uiScrollNever, null, true, true, pages, true, false);
                    return gridOptions.rfmValuesDetailsGridOption; break;
                };
            }
        },
        ...
        getMultiGridLayout: function (gridOptions, uiGridConstants, result, type) {
            switch (type) {
                ...
                case CONSTANTS.RFMVALUES_DETAILS: {
                    return allGrids.rfmValuesDetailsGrid.getGridLayout(gridOptions, result, type, uiScrollNever); break;
                };
            }
        ...
        getToggleDetails: function ($scope, visible, type) {
            ...
            var toggleContents = {
                ...
                RFMValues: ['toggleRFMValuesDetails', 'togglRFMValuesHeader', 'toggleRFMValuesLoader', 'liRFMValuesDetails']
            };
            ...
            switch (type) {
                ...
                case CONSTANTS.RFMVALUES_DETAILS: { return toggle.getToggleType(toggleContents.RFMValues); break; };
            }
...
angular.module('constituent').factory('constituentApiService', ['$http', 'CONSTANTS', function ($http, CONSTANTS) {
    var urls = {};
    ...
    urls[CONSTANTS.RFMVALUES_DETAILS] = BasePath + 'Test/GetRFMValues/';
...
var CONSTITUENT_MESSAGES = {
    PLEASE_SELECT: "Please select either Individual or Organization records for unmerging",
    ALERT: "Alert",
    ATLEAST_ONE: "Please select at least 1 record",
    ACCESS_DENIED_HEADER: "Error: Access Denied",
    TIMED_OUT_HEADER: "Error: Timed Out",
    CHECK_SELECTED: "ChkSelected",
    LOCAL_STORAGE_CLEARED: "LocalStorage seems just to be cleared out! Please proceed with the regular search",
    ONLY_NUMBERS: "Please enter only numbers for MasterId field",
    NO_RESULTS: "No Results found!",
    INTERNAL_SERVER_ERROR: "Internal Server Error",
    CONST_SHOW: "Show All Records",
    CONST_HIDE: "Hide Inactive",
    NO_RECORDS_TO_SEARCH: "No Records found to search",
    MERGE_ERROR_HEADER: 'Merge Error!',
    MERGE_ERROR_MESSAGE: "Please select either Individual or Organization records for merging",
    MERGE_AT_LEAST_TWO: "Please select at least two records to merge",
    EXPORTED_SHORTLY: "File will be exported shortly.",
    EXPORTING: "Exporting...",

    BIRTH_TITLE: "Birth",
    DEATH_TITLE: "death",
    EMAIL_TITLE: "email",
    IND_NAME_TITLE: "Individual Name",
    ORG_NAME_TITLE: "Organization Name",
    EXT_BRID_TITLE: "External Bridge",
    PHONE_TITLE: "Phone",
    INT_BRID_TITLE: "Internal Bridge",
    CNCT_PREF_TITLE: "Contact Preference",
    CHARAC_TITLE: "Characteristics",
    ADDR_TITLE: "Address",
    ERROR: "ERROR!",
    SET_MSTR_GRP: "Set MasterGroup for at least one record"
...
angular.module('constituent').factory('constituentCRUDapiService', ['$http', function ($http) {
...
angular.module('constituent').factory('constClearDataService', ['constMultiDataService', 'constituentDataServices', function (constMultiDataService, constituentDataServices) {
...
angular.module('constituent').factory('constRecordType', function () {
    var type = null;
...
angular.module('constituent').factory('globalServices', function () {
...
angular.module('constituent').factory("ConstituentEmailDomainService", ['$http',
    function ($http) {
        //base Path
