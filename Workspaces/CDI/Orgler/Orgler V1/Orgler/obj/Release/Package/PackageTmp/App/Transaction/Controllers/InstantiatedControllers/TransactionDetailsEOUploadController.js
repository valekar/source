angular.module('transaction').controller('TransactionDetailsEOUploadController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.EO_UPLOAD);
    ...
    if (params) {
        ...
        TransactionApiServices.getApiEOUploadDetails(params).success(function (results) {
