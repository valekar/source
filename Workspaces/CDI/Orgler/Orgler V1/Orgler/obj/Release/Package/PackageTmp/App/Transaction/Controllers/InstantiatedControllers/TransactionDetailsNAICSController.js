angular.module('transaction').controller('TransactionDetailsNAICSController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_NAICS);
   ...
   // console.log("In NAICS Details Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiNAICSDetails(params).success(function (results) {
