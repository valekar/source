angular.module('transaction').controller('TransactionDetailsEmailOnlyUploadController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_EMAIL_UPLOAD);
   ...
   // console.log("In Email only upload Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiEmailOnlyUploadDetails(params).success(function (results) {
