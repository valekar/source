...
var CONST_SHOW = CONSTITUENT_MESSAGES.CONST_SHOW;
var CONST_HIDE = CONSTITUENT_MESSAGES.CONST_HIDE;
...
function ($scope, constituentServices, uiGridConstants, $stateParams, $location, constituentApiService, constMultiDataService, $window, constituentDataServices,
    ...
    $scope.phoneResearchAllRecords = function () {
        ...
        if (results.length > 0) {
            ...
            messagePopup($rootScope, CONSTITUENT_MESSAGES.NO_RECORDS_TO_SEARCH, CONSTITUENT_MESSAGES.ALERT);
        }
...
function ($scope, constituentServices, uiGridConstants, $stateParams, constMultiDataService, constituentApiService, $window, constMultiGridService, $rootScope, constituentDataServices) {
    ...
    $scope.unmerge.addTocart = function () {
        ...
        if ($scope.unmerge.rows.length > 0) {
            ...
            messagePopup($rootScope, CART.SELECT_MESSAGE, CONSTITUENT_MESSAGES.ALERT);
        }
...
/*********************constituentDetailsEmailDomainController****************/

angular.module('constituent').controller('constituentDetailsEmailDomainController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams',
    'constituentApiService', 'constMultiDataService', '$window', 'constMultiGridService', '$rootScope', 'constituentCRUDoperations', '$uibModal',
function ($scope, constituentServices, uiGridConstants, $stateParams, constituentApiService, constMultiDataService, $window,
    constMultiGridService, $rootScope, constituentCRUDoperations, $uibModal) {
    ...
    var initialize = function () {
        ...
        $scope.toggleHeader = { "display": "none" };
        $scope.pleaseWait = { "display": "none" };
        $scope.liEmailDomain = CONSTITUENT_MESSAGES.CHECK_SELECTED;
        // var columnDefs = constituentServices.getConstDetailsPhoneColumns();
        $scope.currentPage = 1;
        // var options = constituentServices.getGridOptions(uiGridConstants, columnDefs);
        var options = constMultiGridService.getGridOptions(uiGridConstants, HOME_CONSTANTS.EMAIL_DOMAINS, 10);
        $scope.gridOptions = options;
        $scope.gridOptions.onRegisterApi = function (grid) {
            $scope.gridApi = grid;
        }
    ...
    if (params != "") {
        ...
        $scope.pleaseWait = { "display": "block" };
        var finalResults = commonGridDataSetup($scope, HOME_CONSTANTS.EMAIL_DOMAINS, params, $scope.gridOptions,
          uiGridConstants, constituentApiService, constMultiDataService, constMultiGridService, $rootScope);
        $scope.gridOptions = finalResults.gridOp;
    ...
    $scope.commonDeleteGridRow = function (row, grid) {
        commonDeleteGridRow($scope, row, grid, constituentCRUDoperations, $uibModal, $stateParams, $scope.gridOptions, HOME_CONSTANTS.EMAIL_DOMAINS);
    ...
    $scope.showAllrecords = function () {
        switch ($scope.showEmailDomain.showAllButtonName) {
            case CONST_HIDE: {
                ...
                var result = setHomeGridData(HOME_CONSTANTS.EMAIL_DOMAINS, $scope.gridOptions, uiGridConstants, constMultiDataService, constMultiGridService)
                //console.log(result);
                $scope.gridOptions = result.gridOp;
                $scope.totalItems = result.itemCount;
                break;
            ...
            case CONST_SHOW: {
                ...
                var result = setFullHomeGridData(HOME_CONSTANTS.EMAIL_DOMAINS, $scope.gridOptions, uiGridConstants, constMultiDataService, constMultiGridService)
                //console.log(result);
                $scope.gridOptions = result.gridOp;
                $scope.totalItems = result.itemCount;
                break;
...
/*********************constituentDetailsNaicsCodeController****************/

angular.module('constituent').controller('constituentDetailsNaicsCodeController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams',
    'constituentApiService', 'constMultiDataService', '$window', 'constMultiGridService', '$rootScope', 'constituentCRUDoperations', '$uibModal',
function ($scope, constituentServices, uiGridConstants, $stateParams, constituentApiService, constMultiDataService, $window,
    constMultiGridService, $rootScope, constituentCRUDoperations, $uibModal) {
    ...
    var initialize = function () {
        ...
        $scope.currentPage = 1;
        // var options = constituentServices.getGridOptions(uiGridConstants, columnDefs);
        var options = constMultiGridService.getGridOptions(uiGridConstants, HOME_CONSTANTS.NAICS_CODES, 10);
        $scope.gridOptions = options;
        $scope.gridOptions.onRegisterApi = function (grid) {
            $scope.gridApi = grid;
        }
    ...
    if (params != "") {
        ...
        $scope.pleaseWait = { "display": "block" };
        var finalResults = commonGridDataSetup($scope, HOME_CONSTANTS.NAICS_CODES, params, $scope.gridOptions,
          uiGridConstants, constituentApiService, constMultiDataService, constMultiGridService, $rootScope);
        $scope.gridOptions = finalResults.gridOp;
    ...
    $scope.commonDeleteGridRow = function (row, grid) {
        commonDeleteGridRow($scope, row, grid, constituentCRUDoperations, $uibModal, $stateParams, $scope.gridOptions, HOME_CONSTANTS.NAICS_CODES);
...
/*********************constituentDetailsContactsController****************/

angular.module('constituent').controller('constituentDetailsContactsController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams',
    'constituentApiService', 'constMultiDataService', '$window', 'constMultiGridService', '$rootScope', 'constituentCRUDoperations', '$uibModal',
function ($scope, constituentServices, uiGridConstants, $stateParams, constituentApiService, constMultiDataService, $window,
    constMultiGridService, $rootScope, constituentCRUDoperations, $uibModal) {
    ...
    var initialize = function () {
        ...
        $scope.currentPage = 1;
        // var options = constituentServices.getGridOptions(uiGridConstants, columnDefs);
        var options = constMultiGridService.getGridOptions(uiGridConstants, HOME_CONSTANTS.CONTACTS_DETAILS, 10);
        $scope.gridOptions = options;
        $scope.gridOptions.onRegisterApi = function (grid) {
            $scope.gridApi = grid;
        }
    ...
    if (params != "") {
        ...
        $scope.pleaseWait = { "display": "block" };
        var finalResults = commonGridDataSetup($scope, HOME_CONSTANTS.CONTACTS_DETAILS, params, $scope.gridOptions,
          uiGridConstants, constituentApiService, constMultiDataService, constMultiGridService, $rootScope);
        $scope.gridOptions = finalResults.gridOp;
    ...
    $scope.commonDeleteGridRow = function (row, grid) {
        commonDeleteGridRow($scope, row, grid, constituentCRUDoperations, $uibModal, $stateParams, $scope.gridOptions, HOME_CONSTANTS.CONTACTS_DETAILS);
...
angular.module('constituent').controller('constituentDetailsAlternateIdsController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams',
    'constituentApiService', 'constMultiDataService', '$window', 'constMultiGridService', '$rootScope', 'constituentCRUDoperations', '$uibModal',
function ($scope, constituentServices, uiGridConstants, $stateParams, constituentApiService, constMultiDataService, $window,
    constMultiGridService, $rootScope, constituentCRUDoperations, $uibModal) {
    ...
    var initialize = function () {
        ...
        $scope.currentPage = 1;
        // var options = constituentServices.getGridOptions(uiGridConstants, columnDefs);
        var options = constMultiGridService.getGridOptions(uiGridConstants, HOME_CONSTANTS.ALTERNATEIDS_DETAILS, 10);
        $scope.gridOptions = options;
        $scope.gridOptions.onRegisterApi = function (grid) {
            $scope.gridApi = grid;
        }
    ...
    if (params != "") {
        ...
        $scope.pleaseWait = { "display": "block" };
        var finalResults = commonGridDataSetup($scope, HOME_CONSTANTS.ALTERNATEIDS_DETAILS, params, $scope.gridOptions,
          uiGridConstants, constituentApiService, constMultiDataService, constMultiGridService, $rootScope);
        $scope.gridOptions = finalResults.gridOp;
    ...
    $scope.commonDeleteGridRow = function (row, grid) {
        commonDeleteGridRow($scope, row, grid, constituentCRUDoperations, $uibModal, $stateParams, $scope.gridOptions, HOME_CONSTANTS.ALTERNATEIDS_DETAILS);
...
angular.module('constituent').controller('constituentDetailsRFMValuesController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams',
    'constituentApiService', 'constMultiDataService', '$window', 'constMultiGridService', '$rootScope', 'constituentCRUDoperations', '$uibModal',
function ($scope, constituentServices, uiGridConstants, $stateParams, constituentApiService, constMultiDataService, $window,
    constMultiGridService, $rootScope, constituentCRUDoperations, $uibModal) {
    ...
    var initialize = function () {
        ...
        $scope.currentPage = 1;
        // var options = constituentServices.getGridOptions(uiGridConstants, columnDefs);
        var options = constMultiGridService.getGridOptions(uiGridConstants, HOME_CONSTANTS.RFMVALUES_DETAILS, 10);
        $scope.gridOptions = options;
        $scope.gridOptions.onRegisterApi = function (grid) {
            $scope.gridApi = grid;
        }
