angular.module('transaction').controller('TransactionDetailsCharacteristicsController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_CHARACTERISTICS);
    ...
    //console.log("In Characteristics Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiCharacteristicsDetails(params).success(function (results) {
