...
angular.module('constituent').controller('AddPhoneInstantiateCtrl',['$http', '$scope', '$filter', '$uibModalInstance', '$uibModal', '$localStorage', '$sessionStorage', 'globalServices',
    ...
    function ($http, $scope, $filter, $uibModalInstance, $uibModal, $localStorage, $sessionStorage, globalServices,
    params, constMultiDataService, constMultiGridService, uiGridConstants,
    constituentCRUDapiService, dropDownService, ConstUtilServices, $rootScope, constituentApiService) {
    $scope.phoneTypes = [];
...
/// <reference path="../../Views/multi/ConstMultiPhone.tpl.html" />
angular.module('constituent').controller('EditPhoneInstantiateCtrl', ['$http', '$scope', '$filter', '$uibModalInstance', '$localStorage', '$sessionStorage', 'globalServices',
...
angular.module('constituent').controller("DeletePhoneInstantiateCtrl", ['$http', '$scope', '$filter', '$uibModalInstance', '$localStorage', '$sessionStorage', 'dropDownService', 'globalServices',
    ...
    function ($http, $scope, $filter, $uibModalInstance, $localStorage, $sessionStorage, dropDownService, globalServices,
    params, constMultiDataService, constMultiGridService, uiGridConstants, constituentCRUDapiService, ConstUtilServices, constituentApiService, $rootScope) {
    var row = params.row;
    //case Prepopulation
    if (globalServices.getCaseTabCaseNo() != null) {
