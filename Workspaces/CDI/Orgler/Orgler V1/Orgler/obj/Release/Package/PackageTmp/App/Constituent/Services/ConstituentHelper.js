    ...
    return {
              ...
              { field: 'dummy', displayName: 'Icon', minWidth: 40, maxWidth: 40, cellTemplate: 'App/Constituent/Views/common/iconGrid.tpl.html', enableCellEdit: false, },
                ...
                },
               {
...

                {
                 ...
                 {
                     field: 'Action', cellTemplate: 'App/Constituent/Views/common/gridDropDown.tpl.html', displayName: 'User Actions', headerCellTemplate: '<div class="ui-grid-cell-contents wordwrap">User Actions</div>',
                     width: "*", minWidth: 125, maxWidth: 9000//, headerCellTemplate: GRID_FILTER_TEMPLATE
                 }
                 //{
                 //    field: 'close filter', displayName: ' ', headerCellTemplate: GRID_FILTER_TEMPLATE, minWidth: 22, width: 22
        ...
        constExtBridgeColDef: [
                { field: 'cnst_mstr_id', displayName: 'Master Id', enableCellEdit: false, visible: false },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Account Name',
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
                },
                {
                    ...
                    headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Account Primary Address',
                    filter: {
                        condition: uiGridConstants.filter.STARTS_WITH
                    },
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
              ...
              //  { field: 'cnst_mstr_id', displayName: 'Master Id', enableCellEdit: false },
               {
                   ...
                   cellTemplate: '<div class="wordwrap" ng-show="COL_FIELD==\'CDIM\'">LEXNEX</div><div class="wordwrap" ng-show="COL_FIELD!=\'CDIM\'">{{COL_FIELD}}</div>'
               },
                {
...
},
{
    ...
    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
      ...
      ,  showRFMValuesDetailsColdef: [

{
    field: 'line_of_srvc_cd', width: "*", minWidth: 130, maxWidth: 9000,
    displayName: "Line Of Service Code", headerCellTemplate: GRID_HEADER_TEMPLATE,
    filter: {
        condition: uiGridConstants.filter.STARTS_WITH
    },
    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
...
{
    field: 'rcnt_patrng_dt', width: "*", minWidth: 140, maxWidth: 9000,
displayName: "Recent Patronage Date", headerCellTemplate: GRID_HEADER_TEMPLATE,
filter: {
    condition: uiGridConstants.filter.STARTS_WITH
},
cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
...
{
    field: 'totl_dntn_cnt', width: "*", minWidth: 10, maxWidth: 9000,
    displayName: "Total Patronage Count", headerCellTemplate: GRID_HEADER_TEMPLATE,
    filter: {
        condition: uiGridConstants.filter.STARTS_WITH
    },
    // cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
    cellTemplate: '<div ng-show="row.entity.line_of_srvc_cd == \'BIO\'" class="wordwrap">{{COL_FIELD || \'0\'}} drive(s)</div><div ng-show="row.entity.line_of_srvc_cd == \'FR\'" class="wordwrap">{{COL_FIELD || \'0\'}} gift(s)</div><div ng-show="row.entity.line_of_srvc_cd == \'PHSS\'" class="wordwrap">{{COL_FIELD || \'0\'}} order(s)</div>' 

},
{
    field: 'totl_dntn_val', width: "*", minWidth: 10, maxWidth: 9000,
    displayName: "Total Patronage Value", headerCellTemplate: GRID_HEADER_TEMPLATE,
filter: {
    condition: uiGridConstants.filter.STARTS_WITH
},
//cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
cellTemplate: '<div ng-show="row.entity.line_of_srvc_cd == \'BIO\'" class="wordwrap">{{COL_FIELD || \'0\'}} blood unit(s)</div><div ng-show="row.entity.line_of_srvc_cd != \'BIO\'" class="wordwrap">{{COL_FIELD || \'0\' | currency}}</div>'
},
{
    field: 'rcncy_scr', width: "*", minWidth: 10, maxWidth: 9000,
    displayName: "Recency Score", headerCellTemplate: GRID_HEADER_TEMPLATE,
    filter: {
        condition: uiGridConstants.filter.STARTS_WITH
    },
    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
...
{
    field: 'freq_scr', width: "*", minWidth: 10, maxWidth: 9000, 
displayName: "Frequency Score", headerCellTemplate: GRID_HEADER_TEMPLATE,
filter: {
    condition: uiGridConstants.filter.STARTS_WITH
},
cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
...
{
    field: 'dntn_scr', width: "*", minWidth: 10, maxWidth: 9000, 
    displayName: "Value Score", headerCellTemplate: GRID_HEADER_TEMPLATE,
    filter: {
        condition: uiGridConstants.filter.STARTS_WITH
    },
    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>',
...
{
    field: 'totl_rfm_scr', width: "*", minWidth: 10, maxWidth: 9000, 
displayName: "Total RFM Score", headerCellTemplate: GRID_HEADER_TEMPLATE,
filter: {
    condition: uiGridConstants.filter.STARTS_WITH
},
cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>'
...
angular.module('constituent').factory("ConstituentNAICSHelperService", [
    function () {
        return {            
