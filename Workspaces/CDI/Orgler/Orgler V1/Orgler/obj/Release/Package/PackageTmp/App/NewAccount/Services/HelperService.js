/************************* Services - Helper *************************/
newAccMod.factory("NewAccountHelperService", [
    function () {
        return {
            ...
            getPopupMergeGridOptions: function () {
                var gridOption = {
                    paginationPageSize: 10,
                    enableSorting: true,
                    enablePager: false,
            ...
            getNewAccountSearchResultsColDef: function()
            {

                return [
                    { displayName: 'Source System Code', field: 'source_system_code', width: "5%", minWidth: 70, type: 'string', maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    { displayName: 'Source System ID', field: 'source_system_id', width: "5%", minWidth: 100, type: 'string', maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    ...
                    { displayName: 'Mastering Results', field: 'mastering_result', width: "*", minWidth: 70, type: 'string', maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    { displayName: 'Lex ID', visible: false, field: 'lexis_nexis_id', width: "*", minWidth: 70, type: 'string', maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    { displayName: 'Monetary Value', field: 'monetary_value', width: "5%", type: 'number', minWidth: 90, maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD|number}}</div>' },
                    { displayName: 'RFM Score', visible: false, field: 'rfm_score', type: 'number', width: "*", minWidth: 70, maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    ...
                    //{ displayName: 'Names', field: 'name', width: "*", minWidth: 100, type: 'string', maxWidth: 9000, cellTemplate: '<a href="#" ng-click="redirectTo(CONSTANTS.CONST_ORG_NAME)" id="constOrgName">Constituent Org Name</a></li>' },                   
                    ...
                    { displayName: 'Start Date ', field: 'mstr_metric_ts', visible: false, width: "*", minWidth: 70, cellFilter: 'column_date_filter' },
                    { displayName: 'Confirm Account', field: 'status', width: "5%", minWidth: 70, type: 'string', maxWidth: 9000, cellTemplate: 'App/Shared/Views/confirmAction.tpl.html' }
                ];
            },
            getNewAccountSearchResultsMonetaryFormattedColDef: function () {

                return [
                    { displayName: 'Source System Code', field: 'source_system_code', width: "5%", minWidth: 100, type: 'string', maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    { displayName: 'Source System ID', field: 'source_system_id', width: "5%", minWidth: 100, type: 'string', maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    { displayName: 'Master ID', field: 'master_id', width: "5%", minWidth: 100, maxWidth: 9000, type: 'number', cellTemplate: 'App/Shared/Views/searchResultsMasterId.tpl.html' },
                    { displayName: 'Mastering Results', field: 'mastering_result', width: "*", minWidth: 70, type: 'string', maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    { displayName: 'Lex ID', visible: false, field: 'lexis_nexis_id', width: "*", minWidth: 70, type: 'string', maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    { displayName: 'Monetary Value', field: 'monetary_value', width: "5%", type: 'number', minWidth: 90, maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD | currency}}</div>' },
                    { displayName: 'RFM Score', visible: false, field: 'rfm_score', width: "*", type: 'number', minWidth: 70, maxWidth: 9000, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>' },
                    { displayName: 'Names', field: 'name', width: "*", minWidth: 100, type: 'string', maxWidth: 9000, cellTemplate: 'App/Shared/Views/searchResultsSubGridName.tpl.html' },
                    { displayName: 'Addresses', field: 'address', width: "*", minWidth: 100, type: 'string', maxWidth: 9000, cellTemplate: 'App/Shared/Views/searchResultsSubGridAddress.tpl.html' },
                    { displayName: 'Phone Numbers', field: 'phone', visible: false, width: "*", type: 'number', minWidth: 100, maxWidth: 9000, cellTemplate: 'App/Shared/Views/searchResultsSubGridPhone.tpl.html' },
                     { displayName: 'Email', field: 'email', visible: false, width: "*", minWidth: 100, maxWidth: 9000, cellTemplate: 'App/Shared/Views/searchResultsSubGridEmail.tpl.html' },
                    ...
                    { displayName: 'NAICS Title', field: 'listNAICSDesc', width: "20%", minWidth: 200, type: 'string', maxWidth: 9000, cellTemplate: 'App/Shared/Views/searchResultsSubGridNaicsCd.tpl.html' },
                    { displayName: 'Potential Merge?', field: 'has_potential_merge', width: "5%", minWidth: 70, type: 'boolean', maxWidth: 9000, cellTemplate: 'App/Shared/Views/mergeResults.tpl.html' },
                    { displayName: 'Potential Unmerge?', field: 'has_potential_unmerge', width: "5%", type: 'boolean', minWidth: 70, maxWidth: 9000, cellTemplate: 'App/Shared/Views/unmergeResults.tpl.html' },
                    { displayName: 'Start Date ', field: 'mstr_metric_ts', visible: false, width: "*", minWidth: 70, cellFilter: 'column_date_filter' },
                    { displayName: 'Confirm Account', field: 'status', width: "5%", minWidth: 70, type: 'string', maxWidth: 9000, cellTemplate: 'App/Shared/Views/confirmAction.tpl.html' }
            ...
            getNewAccountPotentialMergeColDef: function () {
