angular.module('transaction').controller('TransactionDetailsAddressController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_ADDRESS);
    ...
    if (params) {
        ...
        TransactionApiServices.getApiAddressDetails(params).success(function (results) {
