...
topAccMod.controller("AddEmailInstantiateCtrl", ['$http', '$scope', '$filter', '$uibModalInstance', 'globalServices',
...
topAccMod.controller("EditEmailInstantiateCtrl", ['$scope', '$filter', '$uibModalInstance', 'globalServices',
    'params', 'constMultiDataService', 'constMultiGridService', 'uiGridConstants',
    'constituentCRUDapiService', 'dropDownService', 'ConstUtilServices', 'constituentApiService','$rootScope',
    function ($scope, $filter, $uibModalInstance, globalServices,
    params, constMultiDataService, constMultiGridService, uiGridConstants, constituentCRUDapiService, dropDownService, ConstUtilServices, constituentApiService, $rootScope) {
...
topAccMod.controller("DeleteEmailInstantiateCtrl", ['$scope', '$filter', '$uibModalInstance', 'dropDownService', 'globalServices',
    'params', 'constMultiDataService', 'constMultiGridService', 'uiGridConstants', 'constituentCRUDapiService', 'ConstUtilServices',
    'constituentApiService', '$rootScope', function ($scope, $filter, $uibModalInstance, dropDownService, globalServices,
