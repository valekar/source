...
newAccMod.factory('constituentServices', ['$http', '$rootScope', function ($http, $rootScope) {
...
newAccMod.factory('constituentDataServices', ['$http', '$rootScope',function ($http, $rootScope) {
...
newAccMod.factory('showDetailGridService', ['uiGridConstants', '$rootScope', function (uiGridConstants, $rootScope) {
    var gridColumns = new GridColumns();
...
newAccMod.filter('column_date_filter', ['$filter', function ($filter) {
...
newAccMod.filter('column_date_timestamp_filter', ['$filter', function ($filter) {
    return function (value) {
        if (value != null){
            var localDate = new Date(value);
            var localTime = localDate.getTime();
...
newAccMod.factory('showDetailsPostApiService', ['$http', function ($http) {
    var myURL = {};
...
newAccMod.factory('exportService', ['$http', '$window', function ($http, $window) {
...
newAccMod.factory('dropDownService', ['$http', function ($http) {
...
newAccMod.factory('Stack', [function () {
    var Stack = function () {
...
newAccMod.factory('MessageService', ['$q', 'ModalService', function ($q, ModalService) {
    return {
...
newAccMod.factory('ModalService', ['$rootScope', '$uibModal', '$q', function ($rootScope, $uibModal, $q) {
    return {
