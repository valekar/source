angular.module('transaction').controller('TransactionDetailsOrgEmailDomainController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_ORG_EMAIL_DOMAIN);
   ...
   // console.log("In Org Email Domain Details Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiOrgEmailDomainDetails(params).success(function (results) {
