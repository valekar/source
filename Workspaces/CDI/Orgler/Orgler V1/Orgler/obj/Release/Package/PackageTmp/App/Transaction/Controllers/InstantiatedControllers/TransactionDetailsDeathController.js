angular.module('transaction').controller('TransactionDetailsDeathController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_DEATH);
   ...
   // console.log("In Death Details Controller .............");
   ...
   // console.log(params);
    ...
    if (params) {
        ...
        TransactionApiServices.getApiDeathDetails(params).success(function (results) {
