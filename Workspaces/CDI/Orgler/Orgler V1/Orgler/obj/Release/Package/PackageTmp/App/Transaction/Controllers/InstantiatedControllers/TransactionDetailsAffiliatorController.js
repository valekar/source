angular.module('transaction').controller('TransactionDetailsAffiliatorController', ['$scope', 'uiGridConstants', '$uibModal',
    '$stateParams', '$localStorage', 'TransactionDataServices', '$state', '$window', '$rootScope', 'TransactionMultiGridServices', 'TransactionApiServices', 'TransactionMultiDataServices',
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    $state, $window, $rootScope, TransactionMultiGridServices, TransactionApiServices, TransactionMultiDataServices) {
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_AFFILIATOR);
   ...
   // console.log("In Affiliator Details Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiOrgAffiliatorDetails(params).success(function (results) {
