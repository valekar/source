angular.module('transaction').controller('TransactionDetailsEOSiteUploadController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.EO_SITE_UPLOAD);
    ...
    console.log("In EO Site Upload Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiEOSiteUploadDetails(params).success(function (results) {
