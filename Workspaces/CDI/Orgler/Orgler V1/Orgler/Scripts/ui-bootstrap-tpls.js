...
angular.module("uib/template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/datepicker/popup.html",
    ...
    "    <li ng-transclude></li><li ng-transclude></li>\n" +
    "    <li ng-if=\"showButtonBar\" class=\"uib-button-bar\">\n" +
    "    <span class=\"btn-group pull-left\">\n" +
    "      <button type=\"button\" class=\"btn btn-sm btn-info uib-datepicker-current\" ng-click=\"select('today')\" ng-disabled=\"isDisabled('today')\">{{ getText('current') }}</button>\n" +
    "      <button type=\"button\" class=\"btn btn-sm btn-info uib-datepicker-current\" ng-click=\"select('last7days')\" ng-disabled=\"isDisabled('last7days')\">{{ getText('last7days') }}</button>\n" +
    "      <button type=\"button\" class=\"btn btn-sm btn-info uib-datepicker-current\" ng-click=\"select('last30days')\" ng-disabled=\"isDisabled('last30days')\">{{ getText('last30days') }}</button>\n" +
    "      <button type=\"button\" class=\"btn btn-sm btn-info uib-datepicker-current\" ng-click=\"select('currentmonth')\" ng-disabled=\"isDisabled('currentmonth')\">{{ getText('currentmonth') }}</button>\n" +
    "      <button type=\"button\" class=\"btn btn-sm btn-info uib-datepicker-current\" ng-click=\"select('last3month')\" ng-disabled=\"isDisabled('last3month')\">{{ getText('last3month') }}</button>\n" +
