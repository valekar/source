...
/************************* Services - Data *************************/
angular.module('constituent').factory("ConstituentNAICSService", ['$http',
    function ($http) {
        //base Path
        ...
        return {
            ...
            logRecentNAICSUpdate: function (SearchParams) {
                return $http.post(BasePath + "Test/InsertConstituentRecentNAICS", SearchParams, {
                    headers: {
                        "Content-Type": "application/json",
                        "Accept": "application/json"
                    }
            ...
            getRecentNAICSUpdate: function () {
                return $http.get(BasePath + "Test/GetConstituentRecentNAICSUpdate",
                    {
                        headers: {
                            "Content-Type": "Application/JSON",
                            "Accept": "Application/JSON"
