        ...
        getSearchResultsColumnDef: function () {
            ...
            return [{
                ...
                { field: 'address', displayName: 'Address', cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>', width: "*", minWidth: 350, maxWidth: 9000 },
                 { field: 'state_cd', displayName: 'State', cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>', width: "*", minWidth: 15, maxWidth: 9000 },
                {
                ...
                { field: 'ent_org_name', displayName: 'EO Affiliation', cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>', width: "*", minWidth: 200, maxWidth: 9000 },
                {
                    field: 'ent_has_eo', displayName: 'Has EO?', width: "*", minWidth: 20, maxWidth: 60, cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>', width: "*", minWidth: 80, maxWidth: 9000},
             // { field: 'email_address', displayName: 'Email', cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>', width: "*", minWidth: 200, maxWidth: 9000 },
                {
                    field: 'has_dsp_id', headerTooltip: 'LN ID', displayName: "LN Id?", width: "*", minWidth: 20, maxWidth: 60,
                    cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>',width: "*", minWidth: 80, maxWidth: 9000 
                },
               /*{
...
angular.module('constituent').factory('MessageService', ['$q', 'ModalService', function ($q,ModalService) {
    return {
...
angular.module('constituent').factory('ModalService', ['$rootScope', '$uibModal', '$q', function ($rootScope, $uibModal, $q) {
    return {
