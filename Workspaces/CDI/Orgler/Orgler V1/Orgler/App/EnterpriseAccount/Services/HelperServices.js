        ...
        return {
            ...
            getEnterPriseAccountSearchResultsColDef: function ($scope) {
                var linkCellTemplate =
                         '<a class="text-center wordwrap" ng-href="#" ng-click="grid.appScope.openDetails(row)" style="min-width:80px;max-width:80px;">{{COL_FIELD}}</a>';
                return [
                     ...
                     {
                         field: 'ent_org_id', displayName: 'Enterprise Org ID', enableCellEdit: false, width: "*", minWidth: 80, maxWidth: 150,
