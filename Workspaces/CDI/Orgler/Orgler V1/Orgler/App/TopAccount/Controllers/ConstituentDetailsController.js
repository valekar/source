...
HOME_REDIRECT_URL = BasePath + "topaccount/search/result";


var CONST_SHOW = "Show All Records";
var CONST_HIDE = "Hide Inactive";

topAccMod.controller('constituentOrgNameDetailsController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams',
...
topAccMod.controller('constituentDetailsAddressController',
...
topAccMod.controller('constituentDetailsPhoneController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams', '$location',
...
topAccMod.controller('constituentDetailsEmailController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams',
...
topAccMod.controller('constituentDetailsPotentialMergeController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams',
...
topAccMod.controller('constituentDetailsPotentialUnMergeController', ['$scope', 'constituentServices', 'uiGridConstants', '$stateParams',
    'constMultiDataService', 'constituentApiService', '$window', 'constMultiGridService', '$rootScope', 'constituentDataServices', '$uibModal', '$uibModalInstance',
function ($scope, constituentServices, uiGridConstants, $stateParams, constMultiDataService, constituentApiService, $window, constMultiGridService, $rootScope, constituentDataServices, $uibModal, $uibModalInstance) {
...
topAccMod.controller('cartLinkCtrl', ['constituentServices', '$rootScope', 'constituentDataServices', '$scope', '$location','$window',
