...
topAccMod.controller('AddNameInstantiateCtrl', ['$scope', '$filter', '$uibModalInstance', '$uibModal', '$localStorage', '$sessionStorage', 'globalServices',
...
topAccMod.controller('EditNameInstantiateCtrl', ['$scope', '$filter', '$uibModalInstance', '$uibModal', '$localStorage', '$sessionStorage', 'globalServices',
    'params', 'constMultiDataService', 'constMultiGridService', 'uiGridConstants', 'constituentCRUDapiService',
    'ConstUtilServices', 'uibDateParser', 'constituentApiService', 'constituentCRUDoperations', 'dropDownService','$rootScope',
    function ($scope, $filter, $uibModalInstance, $uibModal, $localStorage, $sessionStorage, globalServices,
    params, constMultiDataService, constMultiGridService, uiGridConstants, constituentCRUDapiService, ConstUtilServices,
...
topAccMod.controller('DeleteNameInstantiateCtrl', ['$scope', '$filter', '$uibModalInstance', '$uibModal', '$localStorage', '$sessionStorage', 'globalServices',
...
////ORG ADD/EDIT/DELETE ////
topAccMod.controller('AddOrgNameInstantiateCtrl', ['$scope', '$filter', '$uibModalInstance', '$uibModal', 'globalServices',
    'params', 'constMultiDataService', 'constMultiGridService', 'uiGridConstants', 'constituentCRUDapiService',
    'ConstUtilServices', 'uibDateParser', 'constituentApiService', 'constituentCRUDoperations', 'dropDownService','$rootScope',
...
topAccMod.controller('EditOrgNameInstantiateCtrl', ['$scope', '$filter', '$uibModalInstance', '$uibModal', 'globalServices',
    'params', 'constMultiDataService', 'constMultiGridService', 'uiGridConstants', 'constituentCRUDapiService',
    'ConstUtilServices', 'uibDateParser', 'constituentApiService', 'constituentCRUDoperations', 'dropDownService','$rootScope',
    function ($scope, $filter, $uibModalInstance, $uibModal, globalServices,
    params, constMultiDataService, constMultiGridService, uiGridConstants, constituentCRUDapiService, ConstUtilServices,
...
topAccMod.controller('DeleteOrgNameInstantiateCtrl', ['$scope', '$filter', '$uibModalInstance', '$uibModal', 'dropDownService', 'globalServices',
    'params', 'constMultiDataService', 'constMultiGridService', 'uiGridConstants', 'constituentCRUDapiService',
    'ConstUtilServices', 'uibDateParser', 'constituentApiService', 'constituentCRUDoperations','$rootScope',
