topAccMod.directive('modal', [function () {
    return {
...
topAccMod.directive('menuPreference', [function () {
    return {
        restrict: "A",
        transclude:true,
...
topAccMod.directive('custommenupref', [function () {
    return {
        link: function (scope, element, attr) {
...
topAccMod.directive('scrolldown', [function () {
    return {
        link: function (scope, element, attr) {
