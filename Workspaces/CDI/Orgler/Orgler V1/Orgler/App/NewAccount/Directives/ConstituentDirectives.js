newAccMod.directive('modal', [function () {
    return {
...
newAccMod.directive('menuPreference', [function () {
    return {
        restrict: "A",
        transclude:true,
...
newAccMod.directive('custommenupref', [function () {
    return {
        link: function (scope, element, attr) {
...
newAccMod.directive('scrolldown', [function () {
    return {
        link: function (scope, element, attr) {
