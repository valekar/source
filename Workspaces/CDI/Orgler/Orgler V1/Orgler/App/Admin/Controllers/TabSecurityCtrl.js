adminMod.controller('TabSecurityCtrl', ['$scope', 'TabSecurityGridServices', '$window', 'uiGridConstants', 'TabSecurityApiServices',
    'ErrorService', '$rootScope', 'TABSECURITY_CONTANTS','ModalService',
    function ($scope, TabSecurityGridServices, $window, uiGridConstants, TabSecurityApiServices, ErrorService, $rootScope, TABSECURITY_CONTANTS, ModalService) {

        $rootScope.inialize = function () {
            $scope.tabSecurity = {
        ...
        function populateUpdatedValues() {
