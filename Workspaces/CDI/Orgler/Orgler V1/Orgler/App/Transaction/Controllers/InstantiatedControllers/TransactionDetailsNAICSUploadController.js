angular.module('transaction').controller('TransactionDetailsNAICSUploadController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_NAICS_UPLOAD);
   ...
   // console.log("In NAICS Upload Details Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiNAICSUploadDetails(params).success(function (results) {
