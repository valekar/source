angular.module('transaction').controller('TransactionDetailsContactPreferenceController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_CONTACT_PREF);
  ...
  //  console.log("In Contact Preference Details Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiContactPreferenceDetails(params).success(function (results) {
