angular.module('transaction').controller('TransactionDetailsOrgTransformsController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_ORG_TRANSFORM);
   ...
   // console.log("In Organization Transforms Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiOrgTransformDetails(params).success(function (results) {
