angular.module('transaction').controller('TransactionDetailsEOAffiliationUploadController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.EO_AFFILIATION_UPLOAD);
    ...
    console.log("In EO Affiliation Upload Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiEOAffiliationUploadDetails(params).success(function (results) {
