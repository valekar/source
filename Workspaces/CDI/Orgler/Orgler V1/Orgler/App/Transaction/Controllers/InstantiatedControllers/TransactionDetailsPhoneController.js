angular.module('transaction').controller('TransactionDetailsPhoneController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_PHONE);
   ...
   // console.log("In Phone Details Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiPhoneDetails(params).success(function (results) {
