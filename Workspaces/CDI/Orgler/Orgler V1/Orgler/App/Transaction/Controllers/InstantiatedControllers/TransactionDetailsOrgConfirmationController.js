angular.module('transaction').controller('TransactionDetailsOrgConfirmationController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_ORG_CONFIRMATION);
   ...
   // console.log("In Org Email Confirmation Details Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiOrgConfirmationDetails(params).success(function (results) {
