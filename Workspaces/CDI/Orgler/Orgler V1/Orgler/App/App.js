...
mainModule.controller('quickSearchController', ['$scope', '$stateParams', '$window', 'mainService', '$location', '$localStorage', '$rootScope', '$timeout',
...
commonModule.factory('mainService', ['$localStorage', '$q', '$http', '$window', function ($localStorage, $q, $http, $window) {
    ...
    return {
        ...
        setLastConstSearchResult: function (result) {
            $localStorage.lastConstSearchResultDataOrg = result;
        },

        getLastConstSearchResult: function () {
            return $localStorage.lastConstSearchResultDataOrg;
        },
        ...
        setLastNewAccountSearchResult: function (result) {
            $localStorage.lastNewAccountSearchResultData = result;
        },

        getLastNewAccountSearchResult: function () {
            return $localStorage.lastNewAccountSearchResultData;
        },       
