...
namespace Orgler.Services
{
    ...
    public class InvokeWebService
    {
        ...
        public static async Task<string> GetResourceAsync(string url, string oauthToken, string ClientID, int intApiTimeout = 100)
        {
            string Result = "";
            ...
            try
            {
                using (client = new HttpClient())
                {
                    ...
                    client.Timeout = TimeSpan.FromSeconds(intApiTimeout);
        ...
        public static async Task<string> PostResourceAsync(string url, string oauthToken, Object data, string ClientID, int intApiTimeout = 100)
        {
            string Result = "";
            HttpClient client = null;
            HttpResponseMessage response = null;
