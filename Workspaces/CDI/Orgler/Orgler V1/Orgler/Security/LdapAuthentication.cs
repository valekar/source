...
namespace Orgler.Security
{
    public class LDAPAuthentication
    {
        ...
        public TabLevelSecurityParams userInformation = new TabLevelSecurityParams();
        ...
        {
            set { _emaiAddress = value; }
            get { return _emaiAddress; }
        }
                    ...
                    foreach (string str in lstDom)
                    {
                        using (PrincipalContext ctx = new PrincipalContext(ContextType.Domain, str))
                        {
                            ...
                            if (user != null)
                            {
                                ...
                                _emaiAddress = user.EmailAddress;
                                log.Info("Auto - " + _emaiAddress);
                    ...
                    foreach (string str in lstDom)
                    {
                        ...
                        using (DirectorySearcher search = new DirectorySearcher(entry))
                        {
                            ...
                            if (null != result)
                            {
                                ...
                                _emaiAddress = (String)result.Properties["mail"][0]; //Keerthana - 18-Apr-2017 - Pulled in the email information as well
                                log.Info("Manual - " + _emaiAddress);
