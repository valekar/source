...
namespace Stuart_V2.Models.Entities
{
    ...
    [Serializable]
    //Class to store the tab level security configurations // since we are reading from a file this class has to serialized
    ...
    public class PostTabLevelSecurityParams
    {
        public string usr_nm { get; set; }
        public string grp_nm { get; set; }
        public string email_address { get; set; }
