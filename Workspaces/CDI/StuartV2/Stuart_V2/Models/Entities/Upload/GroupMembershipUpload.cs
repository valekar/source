...
namespace Stuart_V2.Models.Entities.Upload
{
    ...
    public class ChapterUploadFileDetailsHelper
    {
        ...
        public ChapterUploadFileDetailsHelper()
        {
    ...
    public class GroupMembershipUploadDetails
    {
        ...
        public List<ChapterUploadFileDetailsHelper> ListChapterUploadFileDetailsInput { get; set; }
         ...
         public GroupMembershipUploadDetails()
        {
            System.Security.Principal.IPrincipal p = HttpContext.Current.User;
    ...
    public class GroupMembershipUploadParams
    {
        ...
        public GroupMembershipUploadParams()
        {
            System.Security.Principal.IPrincipal p = HttpContext.Current.User;
            loggedInUserName = p.GetUserName(); //p.Identity.Name;
            TabLevelSecurityParams tabParams = Utility.getUserPermissions(loggedInUserName);
            UserEmail = tabParams.email_address;
        }
    }
    ...
    public class GroupMembershipReferenceInsertData
    {
        ...
        public GroupMembershipReferenceInsertData()
        {
            System.Security.Principal.IPrincipal p = HttpContext.Current.User;
    ...
    public class GroupMembershipDeleteReferenceParam
    {
        ...
        public GroupMembershipDeleteReferenceParam()
        {
            System.Security.Principal.IPrincipal p = HttpContext.Current.User;
            this.LoggedInUser = p.GetUserName();
        }
    }
    ...
    public class GroupMembershipEditReferenceParam
    {
        ...
        public GroupMembershipEditReferenceParam()
        {
            System.Security.Principal.IPrincipal p = HttpContext.Current.User;
            LoggedInUser = p.GetUserName(); //p.Identity.Name;
        }
