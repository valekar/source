angular.module('case').factory('CaseServices', ['$http', '$rootScope', function ($http, $rootScope) {
...
angular.module('case').factory('CaseClearDataService', ['CaseMultiDataService', 'CaseDataServices', function (CaseMultiDataService, CaseDataServices) {  //Temporarily commented CaseMultiDataService
...
angular.module('case').factory('CaseMultiDataService', ['CONSTANTS', function (CONSTANTS) {
    // var bestSmryData = [];
...
angular.module('case').factory('CaseDataServices', ['$http', '$rootScope', '$filter', function ($http, $rootScope, $filter) {
...
angular.module('case').factory('CaseClearDataService', ['CaseMultiDataService', 'CaseDataServices', function (CaseMultiDataService, CaseDataServices) {
...
//Timestamp filter 
angular.module('case').filter('column_timestamp_filter', ['$filter', function ($filter) {
...
//Date Filter
angular.module('case').filter('column_date_filter', ['$filter', function ($filter) {
    return function (value) {
        if (value)
...
angular.module('case').constant('CONSTANTS', {
    CASE_INFO: 'CaseInfo',
...
angular.module('case').factory('caseDropDownService', ['$http', function ($http) {
