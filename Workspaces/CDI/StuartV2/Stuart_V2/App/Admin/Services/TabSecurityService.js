...
angular.module('admin').factory('TabSecurityApiServices', ['TABSECURITY_CONTANTS', '$q','$http', function (TABSECURITY_CONTANTS, $q,$http) {
    ...
    return {
        ...
        getGroupNames: function () {
            return [
                 { id: '', value: '' },
                { id: 'Stuart', value: 'Stuart' },
                { id: 'Stuart Writer', value: 'Stuart Writer' },
                { id: 'Stuart Admin', value: 'Stuart Admin' }
...
//service for grid
angular.module('admin').factory('TabSecurityGridServices', ['uiGridConstants', '$rootScope', function (uiGridConstants, $rootScope) {
    return {
        ...
        getColumnDef: function () {
            ...
            return [
                    ...
                    {
                        field: 'case_tb_access', headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Case Tab Access',
                        cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>', width: "*", minWidth: 60, maxWidth: 300,
                        filter: {
                            condition: uiGridConstants.filter.STARTS_WITH
                        },
                    ...
                    {
                        field: 'upload_tb_access', headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Upload Tab Access',
                        cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>', width: "*", minWidth: 60, maxWidth: 300,
                        filter: {
                            condition: uiGridConstants.filter.STARTS_WITH
                        },
                    ...
                    {
                        field: 'locator_tab_access', headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Locator Tab Access',
                        cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>', width: "*", minWidth: 60, maxWidth: 300,
                        filter: {
                            condition: uiGridConstants.filter.STARTS_WITH
                        },
                    ...
                    {
                        field: 'domn_corctn_access', headerCellTemplate: GRID_HEADER_TEMPLATE, displayName: 'Domain Correction Access?',
                        cellTemplate: '<div class="wordwrap">{{COL_FIELD}}</div>', width: "*", minWidth: 60, maxWidth: 300,
                        filter: {
                            condition: uiGridConstants.filter.STARTS_WITH
                        },
        ...
        getGridOptions: function (columnDefs, enableSelection) {
            return {
                ...
                paginationPageSizes: [10, 20, 25, 30, 35, 40, 45, 50],
...
angular.module('admin').constant('TABSECURITY_CONTANTS', {
    'HTTP_HEADERS': {
        headers: {
    ...
    'REST_GET_TAB_SECURITY_URL': 'AdminNative/GetTabLevelSecurity',
    'REST_UPDATED_GET_TAB_SECURITY_URL': 'AdminNative/GetUpdatedTabLevelSecurity',
    'REST_EDIT_TAB_SECURITY_URL': 'AdminNative/EditTabLevelSecurity',
    'REST_INSERT_TAB_SECURITY_URL': 'AdminNative/InsertTabLevelSecurity',
    'REST_DELETE_TAB_SECURITY_URL': 'AdminNative/DeleteTabLevelSecurity'

});

//error service for handling errors
angular.module('admin').factory('ErrorService', ['$rootScope', 'TABSECURITY_CONTANTS', function ($rootScope, TABSECURITY_CONTANTS) {
    return {
...
angular.module('admin').factory('ModalService', ['$rootScope', '$uibModal', 'TABSECURITY_CONTANTS', 'ErrorService','$q',
