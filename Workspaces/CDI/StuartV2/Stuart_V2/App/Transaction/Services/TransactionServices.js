    ...
    return {
        ...
        getTransSearchResultsColumnDef: function () {
           ...
           // console.log("Into Column Defs");
            ...
            { field: 'sub_trans_typ_dsc', displayName: 'Sub Transaction Type' },
            { field: 'transaction_type', displayName: 'Transaction Type' },
        ...
        getTransSearchGridOptions: function (uiGridConstants, columnDefs) {
            ...
            var rowtpl = '<div ng-class="{\'greenClass\':true,\'darkGreenClass\':row.entity.trans_stat == \'Processed\',\'yellowClass\':row.entity.trans_stat == \'Waiting for approval\', \'redClass\':row.entity.trans_stat == \'Rejected\'}"><div ng-repeat="(colRenderIndex, col) in colContainer.renderedColumns track by col.colDef.name" class="ui-grid-cell" ng-class="{ \'ui-grid-row-header-cell\': col.isRowHeader }" ui-grid-cell></div></div>';
