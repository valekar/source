angular.module('transaction').controller('TransactionDetailsEmailController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_EMAIL);
   ...
   // console.log("In Email Details Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiEmailDetails(params).success(function (results) {
