angular.module('transaction').controller('TransactionDetailsAffiliatorTagsController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_AFFILIATOR_TAGS);
    ...
    //console.log("In Affiliator Tags .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiAffiliatorTagsDetails(params).success(function (results) {
