angular.module('transaction').controller('TransactionDetailsAffiliatorHierarchyController', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, HOME_TRANS_CONSTANTS.TRANS_AFFILIATOR_HIERARCHY);
   ...
   // console.log("In Affiliator Hierarchy Controller .............");
    ...
    if (params) {
        ...
        TransactionApiServices.getApiAffiliatorHierarchyDetails(params).success(function (results) {
