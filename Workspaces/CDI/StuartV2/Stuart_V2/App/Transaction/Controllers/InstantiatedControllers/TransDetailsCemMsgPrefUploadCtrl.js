angular.module('transaction').controller('TransDetailsCemmsgPrefUploadCtrl', ['$scope', 'uiGridConstants', '$uibModal',
...
function ($scope, uiGridConstants, $uibModal, $stateParams, $localStorage, TransactionDataServices,
    ...
    var initialize = function () {
        ...
        var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, TRANS_CONSTANTS.TRANS_CEM_MSG_PREF_UPLD_DETAILS);
    ...
    if (params) {
        ...
        TransactionApiServices.getApiCemMsgPrefUploadDetails(params).success(function (results) {
