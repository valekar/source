angular.module('transaction').controller('TransDetailsMsgPrefCtrl', ['$scope', 'uiGridConstants', '$uibModal',
    ...
    $state, $rootScope, TransactionMultiGridServices, TransactionApiServices, TransactionMultiDataServices, TRANS_CONSTANTS) {
        ...
        var initialize = function () {
            ...
            var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, TRANS_CONSTANTS.TRANS_CEM_MSG_PREF_DETAILS);
            ...
            if (params) {
                ...
                TransactionApiServices.getApiCemMsgPrefDetails(params).success(function (results) {
