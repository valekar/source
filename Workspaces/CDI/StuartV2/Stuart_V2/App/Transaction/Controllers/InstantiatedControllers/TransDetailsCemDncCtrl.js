angular.module('transaction').controller('TransDetailsCemDncCtrl', ['$scope', 'uiGridConstants', '$uibModal',
    ...
    $state, $rootScope, TransactionMultiGridServices, TransactionApiServices, TransactionMultiDataServices,TRANS_CONSTANTS) {
        ...
        var initialize = function () {
            ...
            var options = TransactionMultiGridServices.getGridOptions(uiGridConstants, TRANS_CONSTANTS.TRANS_CEM_DNC_DETAILS);
            ...
            if (params) {
                ...
                TransactionApiServices.getApiCemDncDetails(params).success(function (results) {
