...
namespace ARC.Donor.Data.Entities.Orgler.EnterpriseOrgs
{
    ...
    public class EnterpriseOrgMapper
    {
        public string ent_org_id { get; set; }
        public string ent_org_name { get; set; }
        public string ent_org_src_cd { get; set; }
        ...
        public string fr_cnt { get; set; }
        public string frchpt_cnt { get; set; }
        public string phss_cnt { get; set; }
        public string bio_cnt { get; set; }
        public string eosi_cnt { get; set; }
        public string tag { get; set; }
    }

    public class EnterpriseOrgNAICSOutput
    {
        public string ent_org_id { get; set; }
        public string naics_cd { get; set; }
        public string naics_indus_title { get; set; }
