...
namespace ARC.Donor.Data.Entities.Case
{
    ...
    //public class CaseSearchData
    //{
    //    public IList<Entities.CaseSearchResults> getCaseSearchResults(CaseSearchModel searchInput)
    //    {
    //        Repository rp = new Repository();
    //        var SearchResults = rp.ExecuteSqlQuery<Entities.CaseSearchResults>(SQL.CaseSQL.getCaseAdvSearchResultsSQL(searchInput)).ToList();
