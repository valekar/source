...
{
    public class NameAndEmailUploadSQLDetails
    {
        public static CrudOperationOutput postNameAndEmailUploadCreateTrans(string userId)
        {
            ...
            ParamObjects.Add(SPHelper.createTdParameter("typ", "nm_email_upl", "IN", TdType.VarChar, 20));
            ParamObjects.Add(SPHelper.createTdParameter("subTyp", "nm_email_upl", "IN", TdType.VarChar, 20));
            ...
            ParamObjects.Add(SPHelper.createTdParameter("transNotes", "Name and Email Upload", "IN", TdType.VarChar, 100));
        ...
        public static CrudOperationOutput insertNameAndEmailUploadRecords(NameAndEmailUploadInput gm, List<ChapterUploadFileDetailsHelper> ch, 
            long max_seq_key, long max_grp_seq_key, List<ComUnitKeyOutput> com_unit_key_lst, long strTransactionKey)
        {
            CrudOperationOutput crudOutput = new CrudOperationOutput();
            //NameAndEmailUploadInput gmHelper = new NameAndEmailUploadInput();
           // gmHelper = gm;
            int com_unit_key = -1;
            ...
            ParamObjects.Add(SPHelper.createTdParameter("i_cnst_prefix_nm", gm.cnst_prefix_nm, "IN", TdType.VarChar, 50));
            ParamObjects.Add(SPHelper.createTdParameter("i_cnst_first_nm", gm.cnst_first_nm, "IN", TdType.VarChar, 50));
            ParamObjects.Add(SPHelper.createTdParameter("i_cnst_middle_nm", gm.cnst_middle_nm, "IN", TdType.VarChar, 50));
            ParamObjects.Add(SPHelper.createTdParameter("i_cnst_last_nm", gm.cnst_last_nm, "IN", TdType.VarChar, 50));
            ...
            ParamObjects.Add(SPHelper.createTdParameter("i_upld_typ_key", 3, "IN", TdType.Integer, 20));
            ParamObjects.Add(SPHelper.createTdParameter("i_upld_typ_dsc", "Name and Email Upload", "IN", TdType.VarChar, 100));
        ...
        public static string getComUnitKeySQL(NameAndEmailUploadDetails gm)
        {
            string nk_ecode_string = "";

            foreach (var item in gm.ListNameAndEmailUploadDetails.NameAndEmailUploadInputList)
            {
