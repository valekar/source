...
namespace ARC.Donor.Business.Upload
{
    ...
    public class MsgPrefValidationOutput
    {
        ...
        public List<MsgPrefUploadParams> msgPrefInvalidList { get; set; }
        public List<MsgPrefUploadParams> msgPrefValidList { get; set; }


        public MsgPrefValidationOutput()
        {
            msgPrefInvalidList = new List<MsgPrefUploadParams>();
            msgPrefValidList = new List<MsgPrefUploadParams>();
        }
    }
